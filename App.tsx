...
const gameData = {
    ...
    platform: "PC, Mobile",
    description: "RAID: Shadow Legends is a fantasy-themed, turn-based role-playing gacha game. Battle your way through a visually-stunning mythical RPG realm with hundreds of Champions from 15 playable factions.",
    icon: "https://play-lh.googleusercontent.com/8iU859KwWATMKKZwajIC-uZwnma26QkklvqKxKshvyXZuUjX-HA44RZrWtgoY2CA0fMY=s96-rw",
    stats: {
        totalCodes: 3,
        verifiedCodes: 3,
        usesToday: 153 + 98 + 212,
    },
    rating: 4.8,
    ratingCount: 2154897,
    codes: [
        {
            id: 201,
            benefit: "500k Silver & Brews",
            title: "Free Silver & XP Brews",
            description: "Get 500,000 Silver and 10 XP Brews to level up your champions.",
            rating: 4.9,
            ratingCount: 3451,
            usesToday: 212,
            codesLeft: 642,
            code: "RAID-SLVR-BREW-24",
            tags: ['Hot', 'Verified']
        },
        {
            id: 202,
            benefit: "2 Energy Refills",
            title: "Free Energy Refills",
            description: "Claim 2 free Energy Refills to keep battling in dungeons and campaigns.",
            rating: 4.8,
            ratingCount: 2890,
            usesToday: 153,
            codesLeft: 781,
            code: "RAID-NRGY-RUSH-NOW",
            tags: ['Verified']
        },
        {
            id: 203,
            benefit: "Free Epic Champion",
            title: "Claim a free Epic Champion",
            description: "Unlock a powerful Epic-tier Champion to add to your roster.",
            rating: 5.0,
            ratingCount: 4102,
            usesToday: 98,
            codesLeft: 319,
            code: "RAID-EPIC-CHMP-GET",
            tags: ['Hot', 'Verified']
        }
    ]
};
...
const CodeCard: React.FC<{ code: Code }> = ({ code }) => {
    ...
    return (
        <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden backdrop-blur-sm">
             {status === 'checking' ? (
                ...
                <>
                    ...
                    <div className="bg-slate-50/60 dark:bg-gray-900/60 px-5 py-4">
                        <div className="flex justify-center items-center">
                            <div className="group flex rounded-lg shadow-sm w-full max-w-sm" >
                                ...
                                <div className="relative flex-grow px-4 py-3 bg-white dark:bg-gray-950 border-y-2 border-r-2 border-dotted border-gray-300 dark:border-gray-600 rounded-r-lg flex items-center justify-center min-w-0">
...
const GameHeader: React.FC<{ game: Game }> = ({ game }) => (
    <div className="bg-white/70 dark:bg-gray-900/70 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 backdrop-blur-md">
...
const ThemeToggle: React.FC<{ isDarkMode: boolean; setIsDarkMode: (isDark: boolean) => void; }> = ({ isDarkMode, setIsDarkMode }) => (
    <button
        ...
        className="absolute top-4 right-4 p-2 rounded-full bg-slate-200/50 dark:bg-gray-800/50 text-slate-600 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-gray-700 transition-colors duration-200"
...
const App: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen bg-slate-100 dark:bg-gradient-to-br dark:from-gray-950 dark:to-gray-900 text-slate-800 dark:text-slate-200 font-sans p-4 sm:p-6">
